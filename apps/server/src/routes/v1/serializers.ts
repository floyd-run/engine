...
export function serializeAllocation(allocation: AllocationRow): Allocation {
  return {
    ...
    startTime: allocation.startTime.toISOString(),
    endTime: allocation.endTime.toISOString(),
    buffer: {
      beforeMs: allocation.bufferBeforeMs,
      afterMs: allocation.bufferAfterMs,
    },
...
export function serializeBooking(booking: BookingRow, allocations: AllocationRow[]): Booking {
  return {
    ...
    allocations: allocations.map((a) => ({
      ...
      buffer: {
        beforeMs: a.bufferBeforeMs,
        afterMs: a.bufferAfterMs,
      },
      active: a.active,
    })),
